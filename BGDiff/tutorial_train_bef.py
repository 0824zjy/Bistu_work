...
# Default BEF mode. Shell env can override this.
...
from tutorial_dataset_bef import MyDataset
...
def parse_args():
    ...
    p.add_argument("--exp_name", type=str, default=os.environ.get("EXP_NAME", "exp_bef_sbg"))
    ...
    p.add_argument("--offload_optimizer", action="store_true", default=os.environ.get("OFFLOAD_OPTIMIZER", "0") == "1")
...
trainer = pl.Trainer(
    ...
    num_sanity_val_steps=int(os.environ.get("DIFF_NUM_SANITY_VAL_STEPS", "0")),
)
